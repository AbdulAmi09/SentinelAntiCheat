      ...
      <header className="topBar">
        ...
        <div className="topRight">
          ...
          <div className="arbiterMeta">
            ...
            <span className="roleBadge">Checked {apiCheckedAt ? new Date(apiCheckedAt).toLocaleTimeString("en-US", { hour12: false }) : "None"}</span>
              ...
              <div className="alertList">
                {feedAlerts.map((a) => (
                  <article className="alertItem" key={a.id}>
                    <div className="cardRow">
                      <strong>{a.timestamp ? new Date(a.timestamp).toLocaleTimeString("en-US", { hour12: false }) : "None"}</strong>
